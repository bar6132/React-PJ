    ...
    <Modal.Body>
      <Form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input type="text" id="console" name="console" value={formData.console} onChange={handleInputChange}/>
        </div>
        <div className="form-group">
          <label htmlFor="game_name">Game Name:</label>
          <input type="text" id="game_name" name="game_name" value={formData.game_name} onChange={handleInputChange}/>
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          {formData.game_img && (
            <img src={formData.game_img} alt="Game Preview" style={{ maxWidth: '100%', maxHeight: '300px' }} />
          )}
          <input type="file" id="game_img" name="game_img" accept="image/*" onChange={handleInputChange}/>
        </div>
      </Form>
    </Modal.Body>
    <Modal.Footer>
